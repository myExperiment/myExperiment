...
module FleskPlugins
  ...
  class CaptchaImageChallenge < CaptchaChallenge
    ...
    # Calls cleanup when done to release the memory
    ...
    # Cleans up the memory used by the image.  Destructively clears out the
    # internal image reference, so if you've called +generate+ previously you
    # won't be able to write the image out any longer after calling this
    # method -- you'll need to call +generate+ again.
    #
    def cleanup
      self.image = nil
      GC.start
